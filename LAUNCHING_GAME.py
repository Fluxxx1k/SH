...
try:
    ...
    out_file = []
    out_dirs = []
    need = [1, 'HTML_colors.py', 'HTML_logs.py', 'LAUNCHING_GAME.py', 'SH2.py', 'bot.py', 'colors.py', 'globs.py', 'player.py', 'standard_classes.py', 'standard_functions.py', 'standard_names_SH.py', 'test.py', 'user_color_settings.py', 'user_settings.py', 'utils.py']
