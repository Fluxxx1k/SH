try:
    raise Exception("We won't use colorama, because it doesn't support all colors like i want")
    ...
    GRAY_TEXT = get_best_color_code('\033[90m', '\033[38;5;244m')  # Средне-серый
    BLACK_TEXT = '\033[30m'
    RED_TEXT = '\033[31m'
    GREEN_TEXT = '\033[32m'
    YELLOW_TEXT = '\033[33m'
    ...
    GRAY_BACKGROUND = get_best_color_code('\033[100m', '\033[48;5;244m')
...
GRAY_LIGHT_TEXT = get_best_color_code(GRAY_TEXT, '\033[38;5;252m')  # Светло-серый
GRAY_MEDIUM_TEXT = get_best_color_code(GRAY_TEXT, '\033[38;5;244m')  # Средне-серый
GRAY_DARK_TEXT = get_best_color_code(GRAY_TEXT, '\033[38;5;238m')  # Темно-серый

GRAY_LIGHT_BACKGROUND = get_best_color_code(GRAY_BACKGROUND, '\033[48;5;252m')
GRAY_MEDIUM_BACKGROUND = get_best_color_code(GRAY_BACKGROUND, '\033[48;5;244m')
GRAY_DARK_BACKGROUND = get_best_color_code(GRAY_BACKGROUND, '\033[48;5;238m')
